...
output "kubernetes_endpoint" {
  ...
  sensitive   = true
  value       = google_container_cluster.jenkins-gke.endpoint
}

output "ca_certificate" {
  description = "The cluster ca certificate (base64 encoded)"
  sensitive   = true
  value       = google_container_cluster.jenkins-gke.master_auth.0.cluster_ca_certificate
}
...
output "cluster_name" {
  ...
  value       = google_container_cluster.jenkins-gke.name
}
